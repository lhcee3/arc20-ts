...
import { ArcTwentyTokenClient, ArcTwentyTokenFactory } from '../contracts/clients/ArcTwentyTokenClient';

const fixture = algorandFixture();
Config.configure({ populateAppCallResources: true });

let appClient: ArcTwentyTokenClient;

describe('ArcTwentyToken', () => {
  ...
  beforeAll(async () => {
    ...
    const factory = new ArcTwentyTokenFactory({
      algorand,
